                ...
                <div class="card-body">
                   <form action="{{route('transaksi.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="number" name="no_transaksi" class="form-control @error('no_transaksi') is-invalid @enderror">
                             @error('no_transaksi')
                        ...
                        <div class="form-group">
                            <label for="">Masukan Tanggal Pesan</label>
                        ...
                        <div class="form-group">
                            <label for="">Masukan Tanggal Kembali Rencana</label>
                            <input type="date" name="tgl_rencana" class="form-control @error('tgl_rencana') is-invalid @enderror">
                             @error('tgl_rencana')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
